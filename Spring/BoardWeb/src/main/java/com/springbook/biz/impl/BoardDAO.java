...
public class BoardDAO {
	...
	private final String BOARD_LIST = "select * from board order by seq des";
	...
	public BoardVO getBoard(BoardVO vo) {
		...
		try {
			...
			if(rs.next()) {		// select 한 결과값이 존재 한다면, rs의 값을 board에 setter 주입
				board = new BoardVO();				
	...
	public List<BoardVO> getBoardList(BoardVO vo){
		...
		try {
			...
			while(rs.next()) {	// DB에서 Select한 결과 값을 vo에 저장해서 
				...
				boardList.add(board);	//board 를 ArrayList에 저장함.
			}
